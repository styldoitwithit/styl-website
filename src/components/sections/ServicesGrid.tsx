        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className="group bg-background border border-border rounded-xl p-8 hover:border-gold/50 hover:shadow-[0_0_30px_rgba(201,168,76,0.08)] transition-all duration-300"
              >
                <div className="flex items-start gap-5">
                  <div className="flex-shrink-0 w-12 h-12 bg-gold/10 border border-gold/20 rounded-lg flex items-center justify-center group-hover:bg-gold/20 transition-colors">
